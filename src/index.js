...
function getImg(photo, page) {
  return axios.get(
    `https://pixabay.com/api/?key=32397188-bc9ad69aef35391fe0b27bf18&q=${photo}&image_type=photo&orientation=horizontal&safesearch=true&page=${page}&per_page=${per_page}`
  );
}
